...
public class Pagination<T>
{
    ...
    public static Pagination<T> GetPagination(List<T> data, int pageNumber, int pageSize, int totalcountData)
    {
        ...
        // این فرمولش برای گردن کردن رو بالاس
        ...
        //حالا فرض کن که قبل تقسیم منهای 1 انجام بشه این 109 حالا اگر 109 رو تقسیم بر تعدا سایز کنیم میشه 10 
        //پس این یک عدد کم کردن برای اینه که گردن کردن رو به بالاش درست انجام بشه 
